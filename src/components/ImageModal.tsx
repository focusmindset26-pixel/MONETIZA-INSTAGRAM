    ...
    >
      ...
      >
        ...
        <div className="text-center mb-3">
          <span className="text-xs font-extrabold text-[#22C55E] tracking-[1.5px] uppercase">
        ...
        <div className="mt-4 flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-white/10">
          ...
          <button
            ...
            className="w-full sm:w-auto bg-gradient-to-b from-[#22C55E] to-[#16A34A] text-black font-black text-xs uppercase tracking-wider py-3 px-6 rounded-md shadow hover:shadow-[0_4px_20px_rgba(34,197,94,0.5)] transition-all cursor-pointer"
          >
